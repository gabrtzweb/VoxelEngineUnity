...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GgCoreSamplesEditorWindow : GgEditorWindow_MenuTree
    {
        ...
        private Editor editor_RequiredIf;
        private Sample_Attribute_RequiredIf sampleAttributeRequiredIf;
        ...
        protected override GgMenuTree MenuTree()
        {
            return new GgMenuTree
            {
                ...
                pages = new List<GgMenuTreePage>()
                {
                    ...
                    new GgMenuTreePage(Page_RequiredIf, "RequiredIf"),
        ...
        private void Page_RequiredIf()
        {
            string header = "RequiredIf:";
            string description = "The [RequiredIf] attribute will show a warning in the inspector if the value is null and the specified conditions are met.";
            ...
            DrawPage(editor_RequiredIf, header, description, code);
        }
        ...
        private void GetAllAssetReferences()
        {
            ...
            sampleAttributeRequiredIf = EditorExtensions.GetAssetByType<Sample_Attribute_RequiredIf>();
            editor_RequiredIf = sampleAttributeRequiredIf ? Editor.CreateEditor(sampleAttributeRequiredIf) : null;
