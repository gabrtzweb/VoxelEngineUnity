...
namespace System
{
    ...
    internal static class HalfHelper
    {
        ...
        {
            var result = BitConverter.GetBytes(mantissaTable[offsetTable[half.value >> 10] + (half.value & 0x3ff)] + exponentTable[half.value >> 10]);
        ...
        public static bool IsPositive(Half half)
        {
            return (half.value & 0x8000) == 0;
        }
    }
}
